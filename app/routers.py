...
from app.constants import BASE_URL_FETCH_NAMES, BASE_URL_DOWNLOAD_ZIP
from app.database import engine, Base, get_db
from app.models import File
from app.schemas import FileResponse, PaginatedFilesResponse, CalculationResponse, FileStats
...
async def files_page():
    with open(os.path.join(TEMPLATES_DIR, "files.html"), "r", encoding="utf-8") as f:
        return f.read()
